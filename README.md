...
good**. It holds 288 mechanics across 72 games, 97 minigames with their actual reward
...
| | |
|---|---|
| **288 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
