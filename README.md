...
good** — 272 mechanics across 72 games, 94 minigames with their actual reward tables,
...
| | |
|---|---|
| **272 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
| **94 minigames** | 49 carry concrete reward tables — the exact item at the exact threshold, not "prizes and gil" |
