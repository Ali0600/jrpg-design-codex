...
good** — 278 mechanics across 72 games, 96 minigames with their actual reward tables,
...
| | |
|---|---|
| **278 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
