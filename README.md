...
good**. It holds 283 mechanics across 72 games, 97 minigames with their actual reward
...
| | |
|---|---|
| **283 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
| **97 minigames** | 52 carry concrete reward tables — the exact item at the exact threshold, not "prizes and gil" |
