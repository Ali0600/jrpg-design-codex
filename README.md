...
good**. It holds 300 mechanics across 72 games, 103 minigames with their actual reward
...
| | |
|---|---|
| **300 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
