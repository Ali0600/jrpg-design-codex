...
good**. It holds 289 mechanics across 72 games, 98 minigames with their actual reward
...
| | |
|---|---|
| **289 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
