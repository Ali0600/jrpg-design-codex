...
good**. It holds 290 mechanics across 72 games, 98 minigames with their actual reward
...
| | |
|---|---|
| **290 mechanics** | Each with how it works, its reward loop (`do X → get Y → feels good because Z`), and notes on adapting it |
| **98 minigames** | 53 carry concrete reward tables — the exact item at the exact threshold, not "prizes and gil" |
