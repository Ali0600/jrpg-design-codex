...
| 13947 | Guide and Walkthrough | mysticcat | 1.0 | 07/06/2004 | Full Game Guides | 240 | https://gamefaqs.gamespot.com/ps/198265-parasite-eve/faqs/13947 |
...
Coverage 13947: **read on 2026-09-15 as `pick()`'s choice** (Most Recommended, plain text) — single
page, 240,481 chars, 5,883 lines, 283 sections. `lines()` windows: 384–405 (the Tune-Up and BP icons),
438–477 (the battle system, armour and weapons), 986–995 (Wayne and Torres at the police station),
3196–3217 (the survival armour table), 3284–3295 (a Carnegie Hall trick), 3309–3332 (300 Junks) and
3510–3531 (What is EX Game?). Greps: threshold (1 hit), rewards (54), hidden (70), upgrades (327),
economy (43), Bonus Point (11), tools, junk and Wayne (55), Chrysler and EX Game (119), junk (10) and
card (50). Largest unread: IMPORTANT NOTES (25,749 chars; the survival-armour window sits inside
it), Crocodile (6,478) and the Museum of Natural History (5,906).
...
`__gf.triage()` and `__gf.pick()` on 2026-09-15: 37 guides listed (7 Full Game Guides, 15 In-Depth
Guides, 15 under other headings: two foreign-language walkthroughs, a Secrets Guide under Codes and
Secrets, and twelve maps, none read). The scores below were computed once with the probe's own
`core.triage` over the whole listing, since `triage()` in the page scores only the rows under its size
cap. `pick()` named mysticcat's walkthrough, 13947 (Most Recommended, plain text), which the 2026-09-06
pass had not used and which is now read under the owner's rule. That pass predates this record, so its
decisions come from its Sources table and summary above.

| id | title | author | category | KB | score | decision | flags |
|---|---|---|---|---|---|---|---|
| 72450 | Text Dump | Moeman_ | In-Depth Guides | 171 | 4 | skipped — a text dump | — |
| 14155 | Story FAQ | mysticcat | In-Depth Guides | 129 | 4 | skipped — the story | — |
| 4082 | EX Mode Guide | KWee | In-Depth Guides | 62 | 4 | read | — |
| 50263 | Game Mechanic Guide | PrinceThrakhath | In-Depth Guides | 56 | 4 | read | — |
| 4084 | FMV Guide | KWee | In-Depth Guides | 30 | 4 | skipped — the game's videos | — |
| 4081 | EX Mode Guide | DKusama | In-Depth Guides | 27 | 4 | skipped — a second EX Mode guide | — |
| 4077 | Inventory List | SIwata | In-Depth Guides | 27 | 4 | skipped — an item list | — |
| 30073 | Level 38 Trick FAQ | enaysoft | In-Depth Guides | 21 | 4 | skipped — one exploit | — |
| 13947 | Guide and Walkthrough | mysticcat | Full Game Guides | 240 | 3 | read | Most Recommended |
| 80267 | Walkthrough | _Young-Gamer_ | Full Game Guides | 86 | 3 | skipped — a second walkthrough, and HTML | Highest Rated · HTML |
| 65855 | Chrysler Building Guide | Sop-sama | In-Depth Guides | 17 | 3 | skipped — the tower, which the EX Mode guide read covers | — |
| 22240 | Chrysler Building Walkthrough | Suppo | In-Depth Guides | 12 | 3 | skipped — the tower again | — |
| 4083 | EX Mode Guide | WAvalon | In-Depth Guides | 7 | 3 | skipped — a third EX Mode guide | — |
| 24196 | Chrysler Building Maps | PBowman | In-Depth Guides | 5 | 3 | skipped — maps | — |
| 19090 | Debug Room FAQ | Odin | In-Depth Guides | 3 | 3 | skipped — the debug room | — |
| 55672 | Guide and Walkthrough | Shotgunnova | Full Game Guides | 139 | 2 | skipped — another walkthrough | — |
| 4076 | Guide and Walkthrough | taerm | Full Game Guides | 101 | 2 | skipped — another walkthrough | — |
| 7330 | Guide and Walkthrough | NRokk | Full Game Guides | 70 | 2 | skipped — another walkthrough | — |
| 4080 | Walkthrough | Exdeath_Mu | Full Game Guides | 59 | 2 | skipped — another walkthrough | — |
| 8790 | Walkthrough | iamnothing | Full Game Guides | 13 | 1 | skipped — a 13 KB walkthrough | — |
| 4078 | Last Boss Strategy | MRojas | In-Depth Guides | 3 | 0 | skipped — one boss | — |
| 4079 | Translation Guide | Cyath | In-Depth Guides | 19 | -2 | skipped — a translation guide | — |
...
- The walkthrough states the rule from the player's side: Bonus Points arrive with each level, are split between parameters and item capacity, and shrink the more damage was taken [gf:13947 §BP Icon, mysticcat v1.0]; they can also lengthen the Active Time bar, as the Haste spell does [gf:13947 §Battle System, mysticcat v1.0]
- In the EX Game every enemy and boss is much tougher and each day pays Bonus Points; its new location, the Chrysler Building, is where the player meets Maya, the true Eve, whom the guide calls the toughest boss [gf:13947 §What is EX Game?, mysticcat v1.0]
...
- The walkthrough gives the same secret: 300 junk handed to Wayne buys a special weapon of a type the player chooses (handgun, shotgun, machine gun, rifle, grenade launcher or rocket launcher), or of Wayne's choosing, which the guide warns can be the worst [gf:13947 §300 Junks, mysticcat v1.0]
- Wayne also keeps items the player does not need and takes junk and trading cards, and Torres, once given the Mod Permit, adds a slot to a weapon of the player's choice [gf:13947 §Crocodile, mysticcat v1.0]
...
- On Day 1, leaving Carnegie Hall after the first fight instead of chasing the actress lets the medic outside heal Aya fully, and one officer, asked ten times, hands over 60 bullets [gf:13947 §Small Trick in Carnegie Hall, mysticcat v1.0]
...
- Tools and Super Tools move parameters and added effects between weapons or armour, and moving an effect off a piece uses that piece up; how many effects a piece holds depends on its slots, which the NYPD Weapons Department can add [gf:13947 §Tune-up Icon, mysticcat v1.0]
- Armour carries Defense, PE and Critical, weapons carry Attack, Range, Bullets and Rate of Fire, each with an optional special effect, and both are raised with Bonus Points or by merging in another piece with a Tool [gf:13947 §Armors, mysticcat v1.0] [gf:13947 §Weapons, mysticcat v1.0]
- Survival armour trades protection for inventory space: Sv Vest 1 (Central Park), Sv Protector (the Museum) and Sv Jacket add 1 slot, Sv Suit 1 and 2 add 2, and Sv Armor 1 adds 4, the last four found in the Chrysler Building [gf:13947 §Important Notes, mysticcat v1.0]
- Parasite Energy charges by fighting; the guide says no magic or item is needed to fill it [gf:13947 §Battle System, mysticcat v1.0]
...
- The junk total (300) and the Ultimate Weapon reward came from one guide on 2026-09-06; the walkthrough read on 2026-09-15 confirms the 300 and the weapon, calling it a special weapon whose type the player picks [gf:4082 §Secrets, KWee v1.6] [gf:13947 §300 Junks, mysticcat v1.0]
