# Final Fantasy VII (1997) — research digest

Codex: `Final Fantasy VII (1997)` (1997, PlayStation) · GameFAQs: `/ps/197341-final-fantasy-vii` confirmed 2026-09-14 (the
row's harvested `gf.u`) · digest started 2026-09-14
...
This is a reward-table pass (the plan's Section F), not a new research pass: it adds concrete
tables and sources to the eight Final Fantasy VII minigame rows written before the codex asked for
named items and thresholds. No new rows are added; g009–g016 are edited in place.
...
the 3D Battler and Mog, 4) and `lines()` reads of the Wonder Square exchange (92–107), arm wrestling
(112–119), the bike game (176–191), snowboard scoring (297–316), the submarine table (378–397), the
Battle Square prizes (508–527), the chocobo racing classes (870–929) and the Fort Condor chart
(1281–1341). Unread: the Battle Square handicap tables (11,392 chars), the breeding and date chapters,
and the storyline minigames.

Coverage 19004: single page, 19,218 chars, 459 lines, 15 sections — one grep (rewards and prizes, 26
hits) and a `lines()` read of the whole battle list (276–353). Unread: the minigame tips (5,497 chars)
and the rest of the advanced tips.

Coverage 42714: single page, 498,979 chars, 31,762 lines, 158 sections — four greps (the flyers, 5 hits;
the piano, Final Heaven and Elemental, 35; Tifa's piano, 5; the six Sources, 60) and `lines()` reads of
...
headings: 8 Foreign Language Guides, 2 Patch Codes, 1 Demo Guide and 1 Codes and Secrets list, none
read). The probe's cap cut its scored list at 79, so the full list was read once from the page; sizes
...
None new. The tables below are written into the existing rows g009–g016.

### g009 Battle Square
pointers: [wiki:finalfantasy.fandom.com/Battle Square] [gf:45511 §{M1.3} Battle Square, AbsoluteSteve]

| at | get | src |
|---|---|---|
| Before the Tiny Bronco, 80 to 2,560 BP | Potion 80, Phoenix Down 160, Shrapnel 320, Ether 640, Mimett Greens 1,280, Fury Ring 2,560 | [wiki:finalfantasy.fandom.com/Battle Square] [gf:45511 §{M1.3} Battle Square, AbsoluteSteve] |
| Before the Tiny Bronco, 5,120 to 40,960 BP | Enemy Lure 5,120, Pre-Emptive 10,240, Speed Plus 20,480, Champion Belt 40,960 | [wiki:finalfantasy.fandom.com/Battle Square] [gf:45511 §{M1.3} Battle Square, AbsoluteSteve] |
| After the Tiny Bronco | Phoenix Down 100, Remedy 200, Mimett Greens 400, Enemy Lure 800, Bird Wing 1,600, S-Mine 3,200, Pre-Emptive 6,400, Speed Plus 12,800, Champion Belt 25,600, Omnislash 51,200 | [wiki:finalfantasy.fandom.com/Battle Square] [gf:45511 §{M1.3} Battle Square, AbsoluteSteve] |
| After the Highwind | Remedy 100, Enemy Lure 250, Right Arm 500, Pre-Emptive 1,000, Reagan Greens 2,000, Speed Plus 4,000, Stardust 8,000, Champion Belt 16,000, Omnislash 32,000, W-Summon 64,000 | [wiki:finalfantasy.fandom.com/Battle Square] [gf:45511 §{M1.3} Battle Square, AbsoluteSteve] |

### g010 Chocobo racing
pointers: [wiki:finalfantasy.fandom.com/Chocobo Square (Final Fantasy VII)] [gf:45511 §{M1.4} Chocobo Square, AbsoluteSteve]
...
| at | get | src |
|---|---|---|
| Battle 1 | Magic Comb (Red XIII's weapon) | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battle 2 | Peace Ring | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battle 3 | 3 Ethers | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battle 4 | Megalixir | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] [gf:42714 §A) Perishable Items, Xenomic v3] |
| Battles 5 and 6 | 5 Hi-Potions each | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battle 7 | Superball (Yuffie's weapon) | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battles 8 and 9 | 3 Turbo Ethers each | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battles 10 to 12 | 5 X-Potions each | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| Battles 13 and 19 | 3 Elixirs each | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] |
| The final, mandatory battle | Phoenix and Huge Materia, and an Imperial Guard from CMD. Grand Horn | [gf:19004 §When do all the battles take place, Master_Epyon v3.0] [gf:45511 §{M3} Fort Condor, AbsoluteSteve] [wiki:finalfantasy.fandom.com/Fort Condor] |

### g012 Snowboarding
pointers: [wiki:finalfantasy.fandom.com/Snow Game] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve]

| at | get | src |
|---|---|---|
| 89+ points on the Beginner (A) course | 30 GP and a Safety Bit, once | [wiki:finalfantasy.fandom.com/Snow Game] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 89+ points on the Advanced (B) course | 100 GP and All materia, once | [wiki:finalfantasy.fandom.com/Snow Game] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 89+ points on the Crazy (C) course | 300 GP and a Crystal Bangle, once | [wiki:finalfantasy.fandom.com/Snow Game] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |

### g013 G-Bike and Submarine
pointers: [wiki:finalfantasy.fandom.com/Submarine Game] [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve]
...
### g014 Wonder Square
pointers: [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve]

| at | get | src |
|---|---|---|
| Arm wrestling | 1 GP against the Sumo Wrestler, 2 GP against the Wrestler | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| Super Dunk basketball, 44 hits | 300 GP, the most it pays | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 3D Battler, beating the second, third or fourth opponent | 3, 30 or 300 GP | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 1, 20, 80 or 100 GP | a Potion, Ether, X-Potion or Turbo Ether | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 300 GP | Gold Ticket | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 500 GP | Carob Nut | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 1,000 GP, one only, after the Gold Saucer reopens | Gil Plus materia | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |
| 2,000 GP, one only, after the Gold Saucer reopens | EXP Plus materia | [wiki:finalfantasy.fandom.com/Wonder Square (Final Fantasy VII)] [gf:45511 §{M1.1} Wonder Square, AbsoluteSteve] |

### g015 Tifa's piano
pointers: [wiki:finalfantasy.fandom.com/Nibelheim (Final Fantasy VII field)] [gf:42714 §B) Support Materia, Xenomic v3] [gf:42714 §Extra Stats, Xenomic v3]

| at | get | src |
|---|---|---|
| Tifa leading the party at Nibelheim on disc 2, playing the tune | Elemental materia | [wiki:finalfantasy.fandom.com/Nibelheim (Final Fantasy VII field)] [gf:42714 §B) Support Materia, Xenomic v3] |
| The main theme played after Cloud rejoins the party | Zangan's letter with the Final Heaven manual | [wiki:finalfantasy.fandom.com/Nibelheim (Final Fantasy VII field)] [gf:42714 §Extra Stats, Xenomic v3] |

### g016 Turtle's Paradise flyers
pointers: [wiki:finalfantasy.fandom.com/Turtle's Paradise sidequest] [gf:42714 §A) Perishable Items, Xenomic v3] [gf:42714 §C) Other Items, Xenomic v3]

| at | get | src |
|---|---|---|
| Every flyer read, then the bar in Wutai told | a Megalixir and stat-raising Sources, a Power Source among them | [wiki:finalfantasy.fandom.com/Turtle's Paradise sidequest] [gf:42714 §A) Perishable Items, Xenomic v3] [gf:42714 §C) Other Items, Xenomic v3] |
