# Final Fantasy IV — research digest

Codex: `Final Fantasy IV` (unrostered: minigame rows g002–g003 only) · GameFAQs: the DS page `/ds/939425-final-fantasy-iv`,
reached from the Mobile page's listing 2026-09-14 · digest started 2026-09-14
...
A reward-table pass (the plan's Section F) for Final Fantasy IV's two minigame rows. The title has no roster row, so this
digest is claimed through the validator's `UNROSTERED_DIGESTS`. No new rows; g002 and g003 are edited in place. Both
payouts belong to the DS remake: Whyt exists only there, and the original release's developer room pays nothing.
...
None new. The tables below are written into the existing rows g002 and g003.

### g002 Developer's Room
pointers: [wiki:finalfantasy.fandom.com/Developer's Office (Final Fantasy IV 3D)] [gf:53737 §3.29 --- Reach, mystery500 v2.11] [wiki:finalfantasy.fandom.com/Developer's Office (Final Fantasy IV)]

| at | get | src |
|---|---|---|
| DS remake: every task in the Developer's Office done, ending with the Lustful Lali-Ho magazine | Reach augment | [wiki:finalfantasy.fandom.com/Developer's Office (Final Fantasy IV 3D)] [gf:53737 §3.29 --- Reach, mystery500 v2.11] |

### g003 Whyt training (DS)
pointers: [wiki:finalfantasy.fandom.com/Whyt] [gf:51208 §II. Introduction, MostSeriousness] [gf:51208 §Prize, MostSeriousness]

| at | get | src |
|---|---|---|
| A new high score in one of the five minigames | A rise in the Whyt stat that minigame trains | [wiki:finalfantasy.fandom.com/Whyt] [gf:51208 §Prize, MostSeriousness] |
| A minigame score of 1,000 to 6,999 | A prize from Potion, Antidote, Eyedrops, Echo Herb and Golden Needle | [wiki:finalfantasy.fandom.com/Whyt] [gf:51208 §II. Introduction, MostSeriousness] |
| 7,000 to 9,998 | A prize from Ether, Hi-Potion, Phoenix Down, Unicorn Horn and Cottage | [wiki:finalfantasy.fandom.com/Whyt] [gf:51208 §II. Introduction, MostSeriousness] |
| A perfect 9,999 | A prize from Remedy, Hi-Ether and X-Potion, and the matching character's outfit for Whyt | [wiki:finalfantasy.fandom.com/Whyt] [gf:51208 §II. Introduction, MostSeriousness] [gf:51208 §Prize, MostSeriousness] |

## Exploration & upgrade facts

### Hidden
- The original release's Developer's Office holds staff cameos and developers to fight, and was cut from the Easy Type, North American SNES and Pixel Remaster releases [wiki:finalfantasy.fandom.com/Developer's Office (Final Fantasy IV)]
- In the DS office a chest named Kamichi hands over a Kilobyte of Memory and takes it straight back [wiki:finalfantasy.fandom.com/Developer's Office (Final Fantasy IV 3D)]
- Perfect scores pay Whyt five outfits: Rydia's from the Intelligence game, Rosa's from Spirit, a Paladin suit from Strength, a Dragoon outfit from Stamina and a Ninja outfit from Speed [gf:51208 §Prize, MostSeriousness]

### Upgrades
- Whyt's high scores and stat boosts carry over to every other save file on the game card [wiki:finalfantasy.fandom.com/Whyt]
...
```js
// No new rows. g002 and g003 were edited in place: each gained an `rt` table and `refs`, and g002's reward line was
// corrected. Logged in CHANGES as updated.
```
